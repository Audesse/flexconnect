...
#else
    #error "EMIOS_0_CH_22 channel cannot be used by MCL driver. Channel locked by other driver!"
#endif
...
#define MCL_EMIOS_LOGIC_CH0     (uint16)((0U << 8U) + EMIOS_CH_22)
#define MCL_EMIOS_LOGIC_CH1     (uint16)((0U << 8U) + EMIOS_CH_23)
#define MCL_EMIOS_LOGIC_CH2     (uint16)((1U << 8U) + EMIOS_CH_22)
#define MCL_EMIOS_LOGIC_CH3     (uint16)((1U << 8U) + EMIOS_CH_23)
#define MCL_EMIOS_LOGIC_CH4     (uint16)((2U << 8U) + EMIOS_CH_23)
