...
#include "Spi_MemMap.h"
/* External device configuration for SpiExternalDevice_IMU */
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_IMU_MBDT =
{
    SPI_OVER_LPSPI, /* IpType */
    3U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_IMU_Instance_3_MBDT, /* Lpspi IP Config */
...
/* External device configuration for SpiExternalDevice_MPU */
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_MPU_MBDT =
{
    SPI_OVER_LPSPI, /* IpType */
    4U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MPU_Instance_4_MBDT, /* Lpspi IP Config */
        #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
        NULL_PTR, /* Flexio_Spi IP Config */
        #endif
        #if (SPI_IPW_DSPI_ENABLE == STD_ON)
...
/* External device configuration for SpiExternalDevice_DAC */
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_DAC_MBDT =
{
    SPI_OVER_LPSPI, /* IpType */
    3U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_DAC_Instance_3_MBDT, /* Lpspi IP Config */
        #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
        NULL_PTR, /* Flexio_Spi IP Config */
        #endif
        #if (SPI_IPW_DSPI_ENABLE == STD_ON)
...
/* External device configuration for SpiExternalDevice_HB */
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_HB_MBDT =
{
    SPI_OVER_LPSPI, /* IpType */
    3U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_HB_Instance_3_MBDT, /* Lpspi IP Config */
        #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
        NULL_PTR, /* Flexio_Spi IP Config */
        #endif
        #if (SPI_IPW_DSPI_ENABLE == STD_ON)
...
/* External device configuration for SpiExternalDevice_RB */
static const Spi_ExternalDeviceConfigType Spi_ExternalDeviceConfig_SpiExternalDevice_RB_MBDT =
{
    SPI_OVER_LPSPI, /* IpType */
    3U,  /* Instance */
    {   /* ExternalDeviceConfig */
        &Lpspi_Ip_DeviceAttributes_SpiExternalDevice_RB_Instance_3_MBDT, /* Lpspi IP Config */
        #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
        NULL_PTR, /* Flexio_Spi IP Config */
        #endif
        #if (SPI_IPW_DSPI_ENABLE == STD_ON)
...
const Spi_ExDevicesConfigType Spi_aExternalDeviceConfigList_MBDT[5U] =
{
    /* SpiExternalDevice_IMU */
    {
        &Spi_ExternalDeviceConfig_SpiExternalDevice_IMU_MBDT
    },
    /* SpiExternalDevice_MPU */
    {
        &Spi_ExternalDeviceConfig_SpiExternalDevice_MPU_MBDT
    },
    /* SpiExternalDevice_DAC */
    {
        &Spi_ExternalDeviceConfig_SpiExternalDevice_DAC_MBDT
    },
    /* SpiExternalDevice_HB */
    {
        &Spi_ExternalDeviceConfig_SpiExternalDevice_HB_MBDT
    },
    /* SpiExternalDevice_RB */
    {
        &Spi_ExternalDeviceConfig_SpiExternalDevice_RB_MBDT
    }
};
...
static const Spi_HWUnitConfigType Spi_HwUnitConfig_SpiPhyUnit_0_MBDT =
{
        ...
        {
            &Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0_Instance_3_MBDT /* Lpspi IpConfig */
            #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
...
static const Spi_HWUnitConfigType Spi_HwUnitConfig_SpiPhyUnit_1_MBDT =
{
        ...
        (uint32)SPI_SPURIOUS_USER_ID_U32, /* User Id */
        {
            &Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1_Instance_4_MBDT /* Lpspi IpConfig */
            #if (SPI_IPW_SPI_FLEXIO_ENABLE == STD_ON)
            ,NULL_PTR /* Flexio_Spi IpConfig */
            #endif
            #if (SPI_IPW_DSPI_ENABLE == STD_ON)
