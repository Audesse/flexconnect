...
static const IntCtrl_Ip_IrqConfigType aIrqConfiguration[] = {
    ...
    {EMIOS0_2_IRQn, (boolean)TRUE, 0U, &EMIOS0_2_IRQ},
    {EMIOS0_3_IRQn, (boolean)TRUE, 0U, &EMIOS0_3_IRQ},
    {EMIOS0_4_IRQn, (boolean)TRUE, 0U, &EMIOS0_4_IRQ},
    {EMIOS0_5_IRQn, (boolean)FALSE, 0U, &EMIOS0_5_IRQ},
    ...
    {FlexCAN1_0_IRQn, (boolean)TRUE, 5U, &CAN1_ORED_IRQHandler},
    {FlexCAN1_1_IRQn, (boolean)TRUE, 5U, &CAN1_ORED_0_31_MB_IRQHandler},
    {FlexCAN1_2_IRQn, (boolean)TRUE, 5U, &CAN1_ORED_32_63_MB_IRQHandler},
    {FlexCAN2_0_IRQn, (boolean)TRUE, 5U, &CAN2_ORED_IRQHandler},
    {FlexCAN2_1_IRQn, (boolean)TRUE, 5U, &CAN2_ORED_0_31_MB_IRQHandler},
    {FlexCAN2_2_IRQn, (boolean)TRUE, 5U, &CAN2_ORED_32_63_MB_IRQHandler},
    {FlexCAN3_0_IRQn, (boolean)TRUE, 5U, &CAN3_ORED_IRQHandler},
    {FlexCAN3_1_IRQn, (boolean)TRUE, 5U, &CAN3_ORED_0_31_MB_IRQHandler},
    {FlexCAN4_0_IRQn, (boolean)TRUE, 5U, &CAN4_ORED_IRQHandler},
    {FlexCAN4_1_IRQn, (boolean)TRUE, 5U, &CAN4_ORED_0_31_MB_IRQHandler},
    {FlexCAN5_0_IRQn, (boolean)TRUE, 5U, &CAN5_ORED_IRQHandler},
    {FlexCAN5_1_IRQn, (boolean)TRUE, 5U, &CAN5_ORED_0_31_MB_IRQHandler},
    ...
    {LPSPI4_IRQn, (boolean)TRUE, 4U, &Lpspi_Ip_LPSPI_4_IRQHandler},
