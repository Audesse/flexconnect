...
static const Lpi2c_Ip_BaudRateType baudrateParams0_MBDT =
{
    /* .Prescaler */    LPI2C_MASTER_PRESC_DIV_8,
    /* .ClkHI */        1U,
    /* .ClkLO */        3U,
    /* .SetHold */      2U,
    /* .DataValid */    1U,
...
const Lpi2c_Ip_MasterConfigType I2c_Lpi2cMaster_HwChannel0_Channel0_MBDT =
{
    /* .SlaveAddress */     0U,
    /* .DebugMode */        (boolean)FALSE,
    /* .Is10bitAddr */      (boolean)FALSE,
    /* .OperatingMode */    LPI2C_FASTPLUS_MODE,
    /* .BaudrateParams */   &baudrateParams0_MBDT,
    /* .PinLowTimeout */    0U,
    /* .BusIdleTimeout */   0U,
    /* .GlitchFilterSDA */  0U,
    /* .GlitchFilterSCL */  0U,
