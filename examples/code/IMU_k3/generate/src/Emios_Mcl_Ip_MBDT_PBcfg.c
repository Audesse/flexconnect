 ...
 */
const Emios_Ip_MasterBusConfigType Emios_Mcl_Ip_0_MasterBusConfig_MBDT[2U] =
{
    {
...
const Emios_Ip_MasterBusConfigType Emios_Mcl_Ip_1_MasterBusConfig_MBDT[2U] =
{
    {
        /** @brief EMIOS hardware channel used. */
        (uint8)EMIOS_CH_22,
...
const Emios_Ip_MasterBusConfigType Emios_Mcl_Ip_2_MasterBusConfig_MBDT[1U] =
{
    {
        /** @brief EMIOS hardware channel used. */
        (uint8)EMIOS_CH_23,
