...
static Lpspi_Ip_DeviceParamsType Lpspi_Ip_DeviceParamsCfg_MBDT[5U] =
{
    {
        (uint8)8U, /* Frame size */
        (boolean)TRUE, /*Lsb */
...
#include "Spi_MemMap.h"
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_IMU Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_IMU_Instance_3_MBDT =
{
    3U,  /* Instance */
...
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MPU Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_MPU_Instance_4_MBDT =
{
    4U,  /* Instance */
...
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_DAC Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_DAC_Instance_3_MBDT =
{
    3U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
             LPSPI_CFGR0_HRSEL(0U) | LPSPI_CFGR0_HRPOL(0U)), /* CFGR0 */
        (uint32)(LPSPI_CCR_SCKPCS(7U) | LPSPI_CCR_PCSSCK(7U) | LPSPI_CCR_SCKDIV(78U) | LPSPI_CCR_DBT(14U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(0U) | LPSPI_TCR_CPHA(1U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(1U) | LPSPI_TCR_CONT(1U)) /* TCR */
...
#endif
    , &Lpspi_Ip_DeviceParamsCfg_MBDT[2U]
#if (LPSPI_IP_DMA_USED == STD_ON)
#if (STD_ON == LPSPI_IP_ENABLE_DMA_REPEATED_TRANSFER_SUPPORT)
    ,(boolean)FALSE,
    NULL_PTR
...
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_HB Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_HB_Instance_3_MBDT =
{
    3U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
             LPSPI_CFGR0_HRSEL(0U) | LPSPI_CFGR0_HRPOL(0U)), /* CFGR0 */
...
#endif
    , &Lpspi_Ip_DeviceParamsCfg_MBDT[3U]
#if (LPSPI_IP_DMA_USED == STD_ON)
#if (STD_ON == LPSPI_IP_ENABLE_DMA_REPEATED_TRANSFER_SUPPORT)
    ,(boolean)FALSE,
    NULL_PTR
...
/* Lpspi_Ip_DeviceAttributes_SpiExternalDevice_RB Device Attribute Configuration of Spi*/
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_RB_Instance_3_MBDT =
{
    3U,  /* Instance */
    (uint32)(LPSPI_CFGR0_HRDIR(0U) | LPSPI_CFGR0_HREN(0U) |
             LPSPI_CFGR0_HRSEL(0U) | LPSPI_CFGR0_HRPOL(0U)), /* CFGR0 */
        (uint32)(LPSPI_CCR_SCKPCS(39U) | LPSPI_CCR_PCSSCK(39U) | LPSPI_CCR_SCKDIV(3U) | LPSPI_CCR_DBT(38U)), /* ccr */
        (uint32)(LPSPI_TCR_WIDTH(0U) | LPSPI_TCR_CPOL(0U) | LPSPI_TCR_CPHA(0U) | LPSPI_TCR_PRESCALE(0U) | LPSPI_TCR_PCS(2U) | LPSPI_TCR_CONT(1U)) /* TCR */
...
#endif
    , &Lpspi_Ip_DeviceParamsCfg_MBDT[4U]
#if (LPSPI_IP_DMA_USED == STD_ON)
#if (STD_ON == LPSPI_IP_ENABLE_DMA_REPEATED_TRANSFER_SUPPORT)
    ,(boolean)FALSE,
    NULL_PTR
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_0_Instance_3_MBDT =
{
    3U,  /* Instance */
     /* CR */
    (uint32)0,
...
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_1_Instance_4_MBDT =
{
    4U,  /* Instance */
     /* CR */
    (uint32)0,
