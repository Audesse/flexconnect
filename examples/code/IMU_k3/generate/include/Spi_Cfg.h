...
*/
#define SpiConf_SpiChannel_SPI_IMU    ((Spi_ChannelType)0U)
#define SpiConf_SpiChannel_SpiChannel_MPU    ((Spi_ChannelType)1U)
#define SpiConf_SpiChannel_SPIChannel_DAC    ((Spi_ChannelType)2U)
#define SpiConf_SpiChannel_SPIChannel_HB    ((Spi_ChannelType)3U)
#define SpiConf_SpiChannel_SPI_RB    ((Spi_ChannelType)4U)
#define SPI_MAX_CHANNEL (5U)
/**
* @brief Total number of Jobs configured.
* @details Defines the maximum number of supported jobs
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_SpiJob_IMU    ((Spi_JobType)0U)
#define SpiConf_SpiJob_SpiJob_MPU    ((Spi_JobType)1U)
#define SpiConf_SpiJob_SpiJob_DAC    ((Spi_JobType)2U)
#define SpiConf_SpiJob_SpiJob_HB    ((Spi_JobType)3U)
#define SpiConf_SpiJob_SpiJob_RB    ((Spi_JobType)4U)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiSequence_IMU    ((Spi_SequenceType)0U)
#define SpiConf_SpiSequence_SpiSequence_MPU    ((Spi_SequenceType)1U)
#define SpiConf_SpiSequence_SpiSequence_DAC    ((Spi_SequenceType)2U)
#define SpiConf_SpiSequence_SpiSequence_HB    ((Spi_SequenceType)3U)
#define SpiConf_SpiSequence_SpiSequence_IMU_DAC    ((Spi_SequenceType)4U)
#define SpiConf_SpiSequence_SpiSequence_RB    ((Spi_SequenceType)5U)
...
*/
#define SPI_SpiExternalDevice_IMU  ((Spi_ExternalDeviceType)0U)
#define SPI_SpiExternalDevice_MPU  ((Spi_ExternalDeviceType)1U)
#define SPI_SpiExternalDevice_DAC  ((Spi_ExternalDeviceType)2U)
#define SPI_SpiExternalDevice_HB  ((Spi_ExternalDeviceType)3U)
#define SPI_SpiExternalDevice_RB  ((Spi_ExternalDeviceType)4U)
