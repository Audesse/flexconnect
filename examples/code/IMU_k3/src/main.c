...
#define CAN_IMU_BYTES_A_ID 0x9CFF3A65
#define CAN_IMU_BYTES_B_ID 0x9CFF3B65
...
uint8 CAN_IMU_Bytes_A[8] = {0x40, 0x40, 0, 0, 0, 0, 0, 0};
uint8 CAN_IMU_Bytes_B[8] = {0};
Can_PduType Can_PduInfo[CAN_NUMBER_OF_MSG] = {0};
...
void Exec_100ms(void)
{
	...
	Can_PduInfo[0] = Can_CreatePduInfo(CAN_IMU_BYTES_A_ID, 1U, 8U, CAN_IMU_Bytes_A);
	Can_PduInfo[1] = Can_CreatePduInfo(CAN_IMU_BYTES_B_ID, 2U, 8U, CAN_IMU_Bytes_B);
	
	// Transmit IMU data over CAN
